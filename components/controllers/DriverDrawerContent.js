...
import { faHome, faSignOutAlt, faBullhorn, faWrench, faExclamationTriangle } from '@fortawesome/free-solid-svg-icons'
            ...
            <DrawerContentScrollView {...props}>
                <View style={styles.drawerContent}>
                    ...
                    <Drawer.Section style={styles.bottomDrawerSection}>
                        <DrawerItem
                            icon={({ color, size }) => (
                                <FontAwesomeIcon icon={faBullhorn} color='#28587D' size={size} />
                            )}
                            label="İşlerim"
                            onPress={() => { props.navigation.navigate('DJobsScreen') }}
                        />
                    </Drawer.Section>
                    <Drawer.Section style={styles.bottomDrawerSection}>
                        <DrawerItem
